...
from config import BOT_TOKEN, CHANNEL_USERNAME, CHANNEL_LINK, GROUP_USERNAME, GROUP_LINK, BOT_NAME
            ...
            for u in users:
                ...
                if withdrawals:
                    ...
                    for w in withdrawals:
                        ...
                        whist.append(f"{created_at} | {amount} ETB | {bank or '-'} | {account_number or '-'} | {account_name or '-'} | {status}")
